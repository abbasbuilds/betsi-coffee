...
export function Hero() {
  return (
    <section className="relative h-svh w-full overflow-hidden">
      ...
      />
      {/* Dark olive overlay */}
      <div className="absolute inset-0 z-[1] bg-gradient-to-b from-brand-dark/60 via-brand-dark/40 to-brand-dark/75" />
      ...
      <div className="relative z-10 w-full h-full max-w-7xl mx-auto flex flex-col justify-end px-6 pb-16 lg:px-12 lg:pb-24">
        ...
        >
          ...
          <h1 className="font-cormorant leading-[0.88] flex flex-col">
            <span className="text-[clamp(4rem,11vw,9.5rem)] text-white font-light italic">
              Bold as
            </span>
          ...
          <p className="font-dm text-white/65 text-[clamp(0.875rem,1.4vw,1.05rem)] max-w-[500px] mt-5 leading-relaxed">
